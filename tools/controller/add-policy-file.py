...
parser.add_argument('--file', '-f', type=str, default=FILE, help="Policy file to add")
...
import fox
policy_import= fox.dict
print("fox.dict is a %s" % type(policy_import))
...
policy_dict={
    ...
    'filter-mode': 'custom',
    'inactive': False,
    'name': 'BOGUS23-jtb-hardwire-eth12-eth10',
...
cntl.root.applications.bigtap.policy.post(policy_import)
